...
<head>
    <?php $title = "403 Error"; include('partials/title-meta.php'); ?>
                ...
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        <div class="p-4 text-center">
                            <div class="error-text-alt fs-72 text-danger">403</div>
                            <h3 class="fw-bold text-uppercase">Access Denied</h3>
                            ...
                            <div class="mt-4 d-flex justify-content-center gap-1">
                                <button class="btn btn-primary" onclick="window.location.href='index.php'">Go Home</button>
