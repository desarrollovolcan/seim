...
?>
<head>
    <?php $title = "Login with PIN"; include('partials/title-meta.php'); ?>
                ...
                <div class="card auth-box-form border-0 mb-0">
                    ...
                    <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                        ...
                        <p class="text-muted text-center mt-4 mb-0">
                            Not you? Return to <a href="auth-2-sign-in.php" class="text-decoration-underline link-offset-3 fw-semibold">Sign in</a>
                        </p>
