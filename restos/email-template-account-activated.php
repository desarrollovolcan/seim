  ...
  <div class="email-wrapper">
    <div class="email-content">
      ...
      <div class="email-body">
        <p>Hi there,</p>
        <p>We're excited to have you on board. Your <strong>Seim Inventario account</strong> is now active and ready to use.</p>
        ...
        <p>Cheers,<br><b>Seim Inventario Team</b></p>
      </div>
