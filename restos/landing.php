                ...
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <div class="d-flex gap-1 gap-sm-2 flex-wrap justify-content-center">
                        <a class="btn btn-primary py-2 fw-semibold" href="#">
                            <i class="ti ti-basket fs-xl me-2"></i>Buy Seim Inventario Now!
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h2 class="mt-3 fw-bold mb-5">Discover the Core <span class="text-primary">Features</span> of Seim Inventario</h2>
                </div>
            </div>
            ...
            <div class="row align-items-center pb-5">
                ...
                <div class="col-lg-5 ms-auto py-3">
                    <h3 class="mb-3 fs-xl lh-base">Powering Smart Admin Experiences with Seim Inventario</h3>
                    <p class="mb-2 lead">Seim Inventario is a feature-rich, high-performance admin dashboard template built for modern web applications and enterprise-grade interfaces.</p>
                    ...
                    <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Businesses using Seim Inventario</p>
                        </div>
                    </div>
                </div><!-- end col-->
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 py-3 order-2 order-lg-1">
                    ...
                    <p class="mb-2 lead">Seim Inventario empowers admins with a smart, responsive interface to manage users, analytics, content, and workflows effortlessly.</p>
                    ...
                    <a href="dashboard.php" class="btn btn-primary mb-4">Explore Seim Inventario Admin</a>
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                ...
                                <h5 class="my-1 lh-lg">Seim Inventario HQ, 500 Innovation Drive, Suite 200, Metropolis, NY 10101, USA</h5>
                            </div>
                        </div>
                    </div> <!-- end .p-4-->                    
                </div> <!-- end col-->
        ...
        <div class="container">
            <div class="row g-4 justify-content-between">
                <div class="col-lg-3">
                    <img src="assets/images/logo.png" alt="logo" height="24">
                    <p class="mt-3 fs-sm">
                        Seim Inventario is a best-selling admin dashboard template on ThemeForest, recognized for its clean design, versatility, and robust features. Create modern, responsive web applications effortlessly with this top-tier solution!
                    </p>
            ...
            <div class="row mt-5">
                <div class="col-12 text-center">
                    <p class="mb-4">© <script>document.write(new Date().getFullYear())</script> Seim Inventario - tecnologia escalable </p>
                </div>
            </div> <!-- end row-->
        </div> <!-- end container-->
    </footer>
