    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                ?>
                <p><strong>Descuento:</strong> <?php echo e($quoteDiscountLabel); ?></p>
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="mb-1"><strong>N° documento:</strong> <?php echo e($quote['sii_document_number'] ?? ''); ?></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="mb-1"><strong>Comuna:</strong> <?php echo e($quote['sii_receiver_commune'] ?? ''); ?></p>
                ...
                <tbody>
                    <?php foreach ($items as $item): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($itemDiscountLabel); ?></td>
