...
?>
<head>
    <?php $title = "Success Mail"; include('partials/title-meta.php'); ?>
                ...
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        <form>
                            <div class="mb-4">
                                <div class="avatar-xxl mx-auto mt-2">
                                    <div class="avatar-title bg-light-subtle border border-light border-dashed rounded-circle">
                                        <img src="assets/images/email-send.png" alt="dark logo" height="64">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-grid">
                                <a href="index.php" class="btn btn-primary fw-semibold py-2">Bake to Dashboard</a>
                            </div>
                        </form>
                    </div>
