                            ...
                            <div class="card mb-3">
                                <div class="card-header border-bottom">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="mb-1">Create New Campaign</h5>
                                            <p class="text-muted mb-0">Configura la campaña directamente en la página.</p>
                                        </div>
                                        <button type="button" class="btn btn-light btn-icon" data-bs-toggle="collapse" data-bs-target="#createCampaignForm" aria-controls="createCampaignForm" aria-expanded="true">
                                            <i class="ti ti-x"></i>
                                        </button>
                                    </div>
                                </div>
                                <form id="createCampaignFormBody">
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                    ...
                                    <div class="card-footer d-flex flex-column flex-sm-row gap-2">
                                        <button type="button" class="btn btn-light w-100 w-sm-auto" data-bs-toggle="collapse" data-bs-target="#createCampaignForm" aria-controls="createCampaignForm" aria-expanded="true">Cancel</button>
                        ...
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div class="card-header border-light justify-content-between">
                                <div class="d-flex gap-2">
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#createCampaignForm" aria-expanded="false" aria-controls="createCampaignForm">
